...
def function1(intra):
  span=max(intra) - min(intra[1000:])
  return (intra - min(intra[1000:]))/span
...
# UNSEEN = ['AUGW2_D8_DOD15_DIC52_0002_21_32_4000', 'W5FebD1_10nM_Dofe_51_52_8000']
# TO_INCLUDE = [x for x in list(all_recordings.keys()) if x not in unseen]
# print(len(all_recordings.keys()), len(to_include))

#Creating a dataset of all the longer spikes
# /to_include = ['AUGW1_D1_DOD12_DIC49_0001_12_23_4000', 'AUGW1_D1_DOD15_DIC52_0001_12_23_4000', 'AUGW1_D1_DOD15_DIC52_0001_33_22_4000', 'AUGW1_D1_DOD23_DIC60_0001_34_24_4000', 'AUGW1_D1_DOD23_DIC60_0001_78_68_4000', 'AUGW1_D1_DOD23_DIC60_0003_34_14_4000', 'AUGW1_D6_DOD16_DIC53_0001_26_17_4000', 'AUGW2_D1_DOD16_DIC53_0001_21_33_4000', 'AUGW2_D1_DOD16_DIC53_0001_34_24_4000', 'AUGW2_D1_DOD19_DIC56_0001_76_65_4000', 'AUGW2_D1_DOD19_DIC56_0002_61_53_4000', 'AUGW2_D1_DOD19_DIC56_0002_76_65_4000', 'AUGW2_D1_DOD23_DIC60_17_16_4000', 'AUGW2_D1_DOD23_DIC60_61_53_4000', 'AUGW2_D8_DOD15_DIC52_0002_21_32_4000', 'AUGW2_D8_DOD19_DIC56_0001_51_41_4000', 'AUGW2_D8_DOD19_DIC56_0001_83_64_4000', 'AUGW2_D8_DOD23_DIC60_0002_37_38_4000', 'AUGW2_D8_DOD23_DIC60_0002_57_48_4000', 'W5FebD1_10nM_Dofe_51_52_8000', 'W5FebD1_10nM_Dofe_57_58_8000', 'W5FebD1_10nM_Dofe_84_85_8000', 'W8FebD2_10nM_Dofe_57_47_8000', 'W8FebD2_10nM_Dofe_84_74_8000', 'W8FebD3_10nM_Dofe_12_22_8000', 'W8FebD3_10nM_Dofe_24_14_8000', 'W8FebD3_10nM_Dofe_61_62_8000']
# dataset = Dataset(all_recordings, to_include, function1, function2, split=.75)

# Commented out IPython magic to ensure Python compatibility.
# %cd 'Datasets/Long Spikes Remove One'
...
# with open('long_spikes.pkl', 'wb') as outp:
#   pickle.dump(dataset, outp, pickle.HIGHEST_PROTOCOL)

# idx = np.random.choice(len(dataset.intras_raw))
# intra = dataset.intras_normalized[idx]
# extra = dataset.extras_normalized[idx]

# plt.plot(intra, color='blue')
# plt.plot(extra, color='red')

# print('From recording: ' + dataset.recordings[idx][0])
# print('Timestamp: ' + str(dataset.times[idx]))

# trainig_set = dataset.intras_training

def LoadRecordingData():
    seed = 42
    UNSEEN8  = ['W5FebD1_10nM_Dofe_51_52_8000']
    with open('data_sn.pkl', 'rb') as inp:
         all_recordings = pickle.load(inp)

    keys_8000 = [x for x in all_recordings.keys() if '8000' in x ]
    all_train= [x for x in keys_8000]
    
    train_list = ['W5FebD1_10nM_Dofe_51_52_8000',
                 'W5FebD1_10nM_Dofe_57_58_8000',
                 'W5FebD1_10nM_Dofe_84_85_8000',
                 'W8FebD3_10nM_Dofe_24_14_8000',
                 'W8FebD3_10nM_Dofe_61_62_8000']

    test_list = ['W8FebD2_10nM_Dofe_57_47_8000']
    
    data ={}
    seed=42
    for key in keys_8000:
        print(key) 
        d_8 =  MYDataset(all_recordings, [key], function1, function2, test_size=0.0001, val_size = 0.001, seedd = seed  )
        intras = d_8.intras_normalized
        extras = d_8.extras_normalized
        data[(key,'extra')]=extras
        data[(key,'intra')]=intras
    ...
    intras_train =  np.concatenate(intras_train)
    extras_train = np.concatenate(extras_train)
    intras_test =  np.concatenate(intras_test)
    extras_test = np.concatenate(extras_test)
    
    return intras_train,extras_train,intras_test,extras_test